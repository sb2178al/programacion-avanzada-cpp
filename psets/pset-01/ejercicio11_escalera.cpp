...
int main() {
    ...
    std::cout << "Escalera de " << e1.numeroPeldanos << " peldanos: " << (e1.esSegura() ? "segura" : "no segura") << std::endl;
    std::cout << "Escalera de " << e2.numeroPeldanos << " peldanos: " << (e2.esSegura() ? "segura" : "no segura") << std::endl;
